...
typedef unsigned long uintptr_t;
typedef unsigned long size_t;
void klee_make_symbolic(void *addr, size_t nbytes, char const *name);
...
void primes(int *is_prime, int n)
{
  ...
  tmp = 0;
  __e_acsl_initialize((void *)(is_prime + 1),sizeof(int));
  *(is_prime + 1) = tmp;
  __e_acsl_initialize((void *)(is_prime + 0),sizeof(int));
  *(is_prime + 0) = tmp;
  {
    int i_0 = 2;
    while (i_0 * i_0 < n) {
...
void __e_acsl_globals_init(void)
{
  ...
  if (! __e_acsl_already_run) {
    ...
    __gen_e_acsl_literal_string = "variable n";
...
int main(void)
{
  ...
  klee_make_symbolic((void *)(& n),sizeof(n),__gen_e_acsl_literal_string);
  klee_assume((uintptr_t)(n >= 2));
  klee_assume((uintptr_t)(n <= 100));
